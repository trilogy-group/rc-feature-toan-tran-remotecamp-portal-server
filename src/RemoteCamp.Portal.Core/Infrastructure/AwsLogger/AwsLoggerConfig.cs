...
namespace RemoteCamp.Portal.Core.Infrastructure.AwsLogger
{
    ...
    /// 3) Use the AWS SDK for .NET fall back mechanism to find environment credentials.
    /// </para>
    /// </summary>
    public class AwsLoggerConfig : IAwsLoggerConfig
    {
        ...
        public int BatchSizeInBytes
        {
            ...
            set
            {
                ...
                {
                    throw new ArgumentException("The events batch size cannot exceed 1MB. https://docs.aws.amazon.com/AmazonCloudWatch/latest/logs/cloudwatch_limits_cwl.html");
                }
        ...
        /// dictates the timespan after which the Monitor checks the size and time constraint on the batch log event and the existing in-memory buffer for new messages. 
        /// <para>
        /// The value is 500 Milliseconds.
        /// </para>
        /// </summary>
         internal TimeSpan MonitorSleepTime { get; set; } = TimeSpan.FromMilliseconds(500);
        ...
        /// </para>
        /// </summary>
        public string LogStreamNameSuffix { get; set; } = string.Empty;
